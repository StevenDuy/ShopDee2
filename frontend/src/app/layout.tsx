...
export default async function RootLayout({
  ...
  try {
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/p-check`, { cache: 'no-store' });
    if (!res.ok) {
    ...
    backendError = { 
      ...
      help: 'Could not connect to the Backend API server. Check your Cloudflare Tunnel.' 
    };
  }
